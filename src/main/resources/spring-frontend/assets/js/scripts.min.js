    ...
    $(function () {
                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            };getData('/search/next/' + $this.find('.search-input').val(), {
                                offset: 0,
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'tag':
                                ...
                                break;
                            case'search':
                                getData('/search/next/' + $this.data('refreshquery'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function (){
                                                    var oldOfffset = $(slick.$slider).data('loadoffset');
                                                    $(slick.$slider).data('loadoffset', ++oldOfffset);
        ...
        var Transactions = function () {
            ...
            function getData(address, data) {
                var scroll = $(window).scrollTop();
                $.ajax({
                    url: 'https://1111virtserver.swaggerhub.com/lunpully/bookshop/1.0.0' + address,
                    type: 'GET',
                    dataType: 'json',
                    data: data,
                    complete: function (result) {
